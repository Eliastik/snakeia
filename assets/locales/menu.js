...
i18next.addResourceBundle("en", "translation", {
  ...
  "modalAIInformations": {
    ...
    "high": "High",
    "highDescription": "This AI calculates the shortest path to the apple while avoiding obstacles, like the Normal-level AI, but with additional capabilities. It knows how to use the grid's edges to wrap around. If it gets blocked, it falls back to the Low AI's heuristic to try to survive until it can move again.",
