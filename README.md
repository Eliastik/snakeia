...
- [ ] Bug : attendre que le moteur 3D soit initialisé avant d'initialiser la partie (parfois il met du temps alors que la partie commence en parallèle avec le compteur de départ)
